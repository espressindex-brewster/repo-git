const FAQ = [
  ...
  {
    q: 'È legale?',
    a: 'Sì. Chiamare un esercizio commerciale per raccogliere informazioni pubbliche come il prezzo di un prodotto rientra nel legittimo interesse. Il prezzo del caffè non è un dato personale — è un\'informazione che chiunque può ottenere semplicemente entrando in un bar.',
  },
]
